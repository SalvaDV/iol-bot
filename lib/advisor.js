...
Instrumentos disponibles para operar (SOLO estos, cotización disponible vía API): ${WATCHLIST.join(', ')}
También podés recomendar DOLAR_MEP o DOLAR_CCL si dolarizar es la mejor opción (el usuario lo ejecuta manualmente).
IMPORTANTE: NO recomiendes CEDEARs de empresas extranjeras (NVDA, AAPL, MSFT, GOOGL, AMZN, TSLA, META, MELI, etc.) — no podemos ejecutarlos automáticamente.`;
