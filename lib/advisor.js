        ...
        propuestas: {
          ...
          items: {
            ...
            properties: {
              ...
              dir: { type: 'string', enum: ['compra', 'venta', 'dolar', 'crypto', 'crypto_venta'], description: '"compra"/"venta" = órdenes en IOL (solo tickers de WATCHLIST). "crypto" = compra manual en exchange. "crypto_venta" = venta manual en exchange (usá solo si el usuario tiene esa crypto según el historial). "dolar" = dolarización manual.' },
...
CRITERIO CRYPTO COMPRA: dir="crypto" si hay momentum claro (movimiento >5% en 24h, trending, correlación con CEDEARs tech).
CRITERIO CRYPTO VENTA: dir="crypto_venta" solo si el símbolo aparece en "Holdings estimados" con saldo positivo Y hay señal de toma de ganancias o deterioro de momentum.
