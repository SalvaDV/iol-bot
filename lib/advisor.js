...
export async function runAdvisor() {
  ...
  const proponerTool = {
    ...
    description: 'Registra las 3 propuestas de inversión concretas al finalizar el análisis. Siempre llamá esta función.',
    input_schema: {
      type: 'object',
      properties: {
        propuestas: {
...
Al terminar el reporte, llamá a proponer_operaciones con las 3 propuestas.
...
Si ninguno aplica, las 3 propuestas pueden ser todas compras. Para ventas, pct_efectivo = 0.`,
  ...
  // Extraer reporte narrativo y propuestas estructuradas del tool_use
