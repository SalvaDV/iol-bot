...
Análisis de posiciones actuales. Si hay alertas de posiciones (caídas >8% o ganancias >20%), analizalas primero y explicá si conviene actuar o esperar con fundamentos concretos.

💡 *PROPUESTAS CONCRETAS*
3 propuestas ordenadas por riesgo (conservadora, moderada, agresiva). Si hay alertas activas, la primera propuesta debe abordarlas.
...
PRIORIDAD: si hay alertas de posiciones activas, la propuesta 1 debe abordar la más urgente (vender si la caída es seria, o aprovechar si la ganancia sugiere tomar ganancias).
CRITERIO VENTAS: caída >8% con señales técnicas negativas O fundamentals deteriorados O stop loss >10% sin catalizador positivo.
CRITERIO DOLAR: si el macro hace que dolarizar sea mejor que invertir en pesos.
