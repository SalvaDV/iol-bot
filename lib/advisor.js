        ...
        propuestas: {
          ...
          items: {
            ...
            properties: {
              ...
              dir: { type: 'string', enum: ['compra', 'venta', 'dolar', 'crypto'], description: '"compra"/"venta" = órdenes en IOL (solo para tickers de WATCHLIST). "crypto" = compra manual en exchange (NUNCA usar "venta" para crypto — si querés sugerir vender crypto, omitila o sugerí otro instrumento). "dolar" = dolarización manual.' },
...
CRITERIO CRYPTO: si hay momentum claro (movimiento >5% en 24h, trending, correlación con CEDEARs tech), incluí una propuesta con dir="crypto". NUNCA uses dir="venta" para crypto — no tenemos visibilidad de holdings externos. Si querés sugerir tomar ganancias en crypto, mencionalo en el reporte pero no lo pongas como propuesta ejecutable.
